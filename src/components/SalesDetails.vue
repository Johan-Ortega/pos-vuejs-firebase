...
<template>
    <div class="border-t border-gray-200 space-y-6 py-6">
        ...
        <ul role="list" class="mt-6 divide-y divide-gray-200 border-gray-200 text-sm font-medium text-gray-500">
            <li
        ...
        <dl class="space-y-6 border-t border-gray-200 pt-6 text-md font-medium text-gray-500">
            <Amount>
            ...
            <Amount v-if="sale.discount" class="bg-green-200 py-3 px-2 rounded">
